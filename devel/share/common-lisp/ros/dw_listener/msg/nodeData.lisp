...
(cl:defclass <nodeData> (roslisp-msg-protocol:ros-message)
  ((tagAddress
   ...
   (rangeNum
    ...
    :initform 0)
   (timeOfReception
    :reader timeOfReception
    :initarg :timeOfReception
    :type cl:integer
    :initform 0)
   (distance
    :reader distance
...
(cl:defmethod cl:initialize-instance :after ((m <nodeData>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'nodeData)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name dw_listener-msg:<nodeData> is deprecated: use dw_listener-msg:nodeData instead.")))

(cl:ensure-generic-function 'tagAddress-val :lambda-list '(m))
(cl:defmethod tagAddress-val ((m <nodeData>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader dw_listener-msg:tagAddress-val is deprecated.  Use dw_listener-msg:tagAddress instead.")
  (tagAddress m))

(cl:ensure-generic-function 'rangeNum-val :lambda-list '(m))
(cl:defmethod rangeNum-val ((m <nodeData>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader dw_listener-msg:rangeNum-val is deprecated.  Use dw_listener-msg:rangeNum instead.")
  (rangeNum m))

(cl:ensure-generic-function 'timeOfReception-val :lambda-list '(m))
(cl:defmethod timeOfReception-val ((m <nodeData>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader dw_listener-msg:timeOfReception-val is deprecated.  Use dw_listener-msg:timeOfReception instead.")
  (timeOfReception m))

(cl:ensure-generic-function 'distance-val :lambda-list '(m))
(cl:defmethod distance-val ((m <nodeData>))
...
(cl:defmethod Ycoord-val ((m <nodeData>))
...
(cl:ensure-generic-function 'serviceData-val :lambda-list '(m))
(cl:defmethod serviceData-val ((m <nodeData>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader dw_listener-msg:serviceData-val is deprecated.  Use dw_listener-msg:serviceData instead.")
  (serviceData m))

(cl:ensure-generic-function 'Xaccel-val :lambda-list '(m))
(cl:defmethod Xaccel-val ((m <nodeData>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader dw_listener-msg:Xaccel-val is deprecated.  Use dw_listener-msg:Xaccel instead.")
  (Xaccel m))

(cl:ensure-generic-function 'Yaccel-val :lambda-list '(m))
(cl:defmethod Yaccel-val ((m <nodeData>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader dw_listener-msg:Yaccel-val is deprecated.  Use dw_listener-msg:Yaccel instead.")
  (Yaccel m))
...
(cl:defmethod roslisp-msg-protocol:serialize ((msg <nodeData>) ostream)
  ...
  (cl:map cl:nil #'(cl:lambda (c) (cl:write-byte (cl:char-code c) ostream)) (cl:slot-value msg 'tagAddress))
  (cl:let* ((signed (cl:slot-value msg 'rangeNum)) (unsigned (cl:if (cl:< signed 0) (cl:+ signed 18446744073709551616) signed)))
  ...
  (cl:let* ((signed (cl:slot-value msg 'timeOfReception)) (unsigned (cl:if (cl:< signed 0) (cl:+ signed 18446744073709551616) signed)))
    (cl:write-byte (cl:ldb (cl:byte 8 0) unsigned) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 8) unsigned) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 16) unsigned) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 24) unsigned) ostream)
  ...
  (cl:let* ((signed (cl:slot-value msg 'Xcoord)) (unsigned (cl:if (cl:< signed 0) (cl:+ signed 18446744073709551616) signed)))
    (cl:write-byte (cl:ldb (cl:byte 8 0) unsigned) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 8) unsigned) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 16) unsigned) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 24) unsigned) ostream)
  ...
  (cl:let* ((signed (cl:slot-value msg 'Ycoord)) (unsigned (cl:if (cl:< signed 0) (cl:+ signed 18446744073709551616) signed)))
    (cl:write-byte (cl:ldb (cl:byte 8 0) unsigned) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 8) unsigned) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 16) unsigned) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 24) unsigned) ostream)
  ...
  (cl:let* ((signed (cl:slot-value msg 'serviceData)) (unsigned (cl:if (cl:< signed 0) (cl:+ signed 18446744073709551616) signed)))
    (cl:write-byte (cl:ldb (cl:byte 8 0) unsigned) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 8) unsigned) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 16) unsigned) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 24) unsigned) ostream)
  ...
  (cl:let* ((signed (cl:slot-value msg 'Xaccel)) (unsigned (cl:if (cl:< signed 0) (cl:+ signed 18446744073709551616) signed)))
    (cl:write-byte (cl:ldb (cl:byte 8 0) unsigned) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 8) unsigned) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 16) unsigned) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 24) unsigned) ostream)
  ...
  (cl:let* ((signed (cl:slot-value msg 'Yaccel)) (unsigned (cl:if (cl:< signed 0) (cl:+ signed 18446744073709551616) signed)))
    (cl:write-byte (cl:ldb (cl:byte 8 0) unsigned) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 8) unsigned) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 16) unsigned) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 24) unsigned) ostream)
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <nodeData>) istream)
  "Deserializes a message object of type '<nodeData>"
    (cl:let ((__ros_str_len 0))
      ...
      (cl:setf (cl:slot-value msg 'tagAddress) (cl:make-string __ros_str_len))
      (cl:dotimes (__ros_str_idx __ros_str_len msg)
        (cl:setf (cl:char (cl:slot-value msg 'tagAddress) __ros_str_idx) (cl:code-char (cl:read-byte istream)))))
    (cl:let ((unsigned 0))
      ...
      (cl:setf (cl:slot-value msg 'rangeNum) (cl:if (cl:< unsigned 9223372036854775808) unsigned (cl:- unsigned 18446744073709551616))))
    (cl:let ((unsigned 0))
      (cl:setf (cl:ldb (cl:byte 8 0) unsigned) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 8) unsigned) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 16) unsigned) (cl:read-byte istream))
      ...
      (cl:setf (cl:ldb (cl:byte 8 48) unsigned) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 56) unsigned) (cl:read-byte istream))
      (cl:setf (cl:slot-value msg 'timeOfReception) (cl:if (cl:< unsigned 9223372036854775808) unsigned (cl:- unsigned 18446744073709551616))))
    (cl:let ((unsigned 0))
      (cl:setf (cl:ldb (cl:byte 8 0) unsigned) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 8) unsigned) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 16) unsigned) (cl:read-byte istream))
    ...
    (cl:let ((unsigned 0))
      ...
      (cl:setf (cl:ldb (cl:byte 8 48) unsigned) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 56) unsigned) (cl:read-byte istream))
      (cl:setf (cl:slot-value msg 'Ycoord) (cl:if (cl:< unsigned 9223372036854775808) unsigned (cl:- unsigned 18446744073709551616))))
    (cl:let ((unsigned 0))
      (cl:setf (cl:ldb (cl:byte 8 0) unsigned) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 8) unsigned) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 16) unsigned) (cl:read-byte istream))
    ...
    (cl:let ((unsigned 0))
      ...
      (cl:setf (cl:ldb (cl:byte 8 48) unsigned) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 56) unsigned) (cl:read-byte istream))
      (cl:setf (cl:slot-value msg 'serviceData) (cl:if (cl:< unsigned 9223372036854775808) unsigned (cl:- unsigned 18446744073709551616))))
    (cl:let ((unsigned 0))
      (cl:setf (cl:ldb (cl:byte 8 0) unsigned) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 8) unsigned) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 16) unsigned) (cl:read-byte istream))
      ...
      (cl:setf (cl:ldb (cl:byte 8 48) unsigned) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 56) unsigned) (cl:read-byte istream))
      (cl:setf (cl:slot-value msg 'Xaccel) (cl:if (cl:< unsigned 9223372036854775808) unsigned (cl:- unsigned 18446744073709551616))))
    (cl:let ((unsigned 0))
      (cl:setf (cl:ldb (cl:byte 8 0) unsigned) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 8) unsigned) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 16) unsigned) (cl:read-byte istream))
      ...
      (cl:setf (cl:ldb (cl:byte 8 48) unsigned) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 56) unsigned) (cl:read-byte istream))
      (cl:setf (cl:slot-value msg 'Yaccel) (cl:if (cl:< unsigned 9223372036854775808) unsigned (cl:- unsigned 18446744073709551616))))
    (cl:let ((unsigned 0))
      (cl:setf (cl:ldb (cl:byte 8 0) unsigned) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 8) unsigned) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 16) unsigned) (cl:read-byte istream))
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <nodeData>))
  ...
  (cl:list 'nodeData
    (cl:cons ':tagAddress (tagAddress msg))
